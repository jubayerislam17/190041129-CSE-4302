...
public:
    ...
    void showLabs()
    {
        ...
        for (int i = 0; i < labs.size(); i++)
            cout << "Lab " << labs[i].getlabName() << " " << labs[i].getCapacity() << " Capacity\n";
    }
    void showLectureRoom()
    {
        cout << "Show all lecturers rooms:\n";
        for (int i = 0; i < room.size(); i++)
            cout << room[i].getRoomName() << " " << room[i].getRoomNo() << " " << room[i].getCapacity() << " Capacity\n";
    }
};
int main()
{
